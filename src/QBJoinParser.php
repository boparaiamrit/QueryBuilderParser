...
class QBJoinParser extends QueryBuilderParser
{
	...
	/**
	 * @param array $fields                        a list of all the fields that are allowed to be filtered by the
	 *                                             QueryBuilder
	 * @param array $joinFields                    an associative array of the join fields keyed by fields name, with
	 *                                             the following keys
	 ...
	 *                                             - to_value_column  The column of the join table containing the value
	 *                                             to use as a where clause
	 *                                             - to_clause*       An additional clause to add to the join
	 *                                             condition, compatible with $query->where($clause)
	 *                                             - not_exists*      Only return rows which do not exist in the
	 *                                             subclause
	 *
	 * * optional field
	 */
