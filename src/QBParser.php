...
class QBParser
{
     ...
     * @return Builder
     */
    public function parse($query, Builder $querybuilder)
    {
     ...
     * @return Builder
     */
    protected function createNestedQuery(Builder $querybuilder, array $rule, $condition = null)
    {
        if ($condition === null) {
     ...
     */
    protected function checkRuleCorrect(array $rule)
    {
     ...
     * @return null|string
     */
    protected function operatorValueWhenNotAcceptingOne(array $rule)
    {
     ...
     * @return string
     */
    protected function getCorrectValue($operator, array $rule, $value)
    {
        $field = $rule['field'];
     ...
     * @return Builder
     */
    protected function makeQuery(Builder $query, array $rule, $queryCondition = 'AND')
    {
        /*
     ...
     * @return Builder
     */
    protected function convertIncomingQBtoQuery(Builder $query, array $rule, $value, $queryCondition = 'AND')
    {
        /*
     ...
     * @throws \Boparaiamrit\QueryBuilderParser\QBParseException
     *
     * @return mixed
     */
